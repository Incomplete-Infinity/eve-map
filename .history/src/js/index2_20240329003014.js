...
const Interface = {
  ...
  createToolbar: () => {
    Interface.elem.header = Interface.createElement(
      'header',
      document.body,
      true,
      {
...
Layer.background = {
  ...
  drawCrosshair: () => {
    ...
    ctx.fillRect(Viewport.center.x - 4, Viewport.center.y - .5, 8, 1);
    ctx.fillRect(Viewport.center.x - .5, Viewport.center.y - 4, 1, 8);
  },
  drawInfluence: () => {
    let i, j, ci, cj, data;
